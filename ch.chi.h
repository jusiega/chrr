...
constexpr double tpp[7]={1E-7,0,10,3};//rozmiar 7 oczywiście na szczęście
...
constexpr int spoints_x=10001;//mniej więcej points w jeden direction for initial boundary reconassaince
...
constexpr int n_energy_levels=100;//raczej lepiej mniej niż jest beans. nie mylić z ilością charakterystyk która zależna bd także od tego ile jest minimów
